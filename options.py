...
class TrainOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--CropSize", type=int, default=224, help="scale images to this size"
        )
        parser.add_argument("--norm_type", type=str, default="imagenet", help="")
        ...
        parser.add_argument(
            ...
            type=str,
            default="CNNSpot",
            help="choose the detection method",
        )
        parser.add_argument(
            "--dataroot",
            default="/hotdata/share/AIGCDetect",
            help="path to images (should have subfolders trainA, trainB, valA, valB, etc)",
        )
        parser.add_argument(
            "--classes",
            default="airplane,bird,bicycle,boat,bottle,bus,car,cat,cow,chair,diningtable,dog,person,pottedplant,motorbike,tvmonitor,train,sheep,sofa,horse",
        ...
        parser.add_argument(
            "--fix_backbone",
            action="store_true",
            help="useful in UnivFD, if set, fix the backbone and only update fc layer",
        )
        ...
        parser.add_argument(
            "--LNP_modelpath",
            type=str,
            default="/home/lmx/zyr_workspace/AIGCDetectBenchmark/weights/preprocessing/sidd_rgb.pth",
            help="the path of LNP pre-trained model",
        )
        parser.add_argument(
            "--epoch_counter",
            type=int,
...
class TestOptions:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--robust_all", type=bool, default=False, help="all or single"
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--vqvae_path",
            type=str,
            default="./pretrained/vq_ds16_c2i.pt",
            help="the path of vqvae model",
        )
        parser.add_argument(
            "--model_path",
            type=str,
        ...
        parser.add_argument(
            "--noise_type", type=str, default=None, help="such as jpg and crop"
        )
        parser.add_argument("--sub_dir", nargs="+", help="List of sub directories")
        parser.add_argument(
            "--dataroot",
            default="/path/to/your/testset",
            help="path to images (should have subfolders trainA, trainB, valA, valB, etc)",
        )
